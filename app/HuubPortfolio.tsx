        ...
        {active && (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
            ...
            <div className="md:col-span-2">
              ...
              {active.link && (
                <a href={active.link} target="_blank" rel="noreferrer" className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-sm hover:bg-white/10">
